...
namespace v3d::image {
    TextureAtlas::TextureAtlas(unsigned int width, unsigned int height, unsigned int depth, const boost::shared_ptr<v3d::core::Logger>& logger) :
        width_(width),
        height_(height),
        depth_(depth),
        id_(0),
