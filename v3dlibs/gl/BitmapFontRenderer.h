...
namespace v3d::gl {
    ...
    class BitmapFontRenderer final {
     public:
        BitmapFontRenderer(const boost::shared_ptr<v3d::core::Logger> & logger);
        BitmapFontRenderer(boost::shared_ptr<v3d::font::BitmapTextBuffer> buffer, boost::shared_ptr<Program> program, const boost::shared_ptr<v3d::core::Logger>& logger);
