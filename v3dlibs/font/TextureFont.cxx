...
namespace v3d::font {
    class TextureFont::Freetype {
     public:
         explicit Freetype(const boost::shared_ptr<v3d::core::Logger> & logger);
    ...
    TextureFont::Freetype::Freetype(const boost::shared_ptr<v3d::core::Logger>& logger) : logger_(logger) {
    }
    ...
    TextureFont::TextureFont(boost::shared_ptr<v3d::image::TextureAtlas> atlas, const std::string& filename, float size, const boost::shared_ptr<v3d::core::Logger> & logger) :
        atlas_(atlas),
        filename_(filename),
        size_(size),
        height_(0),
