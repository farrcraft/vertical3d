...
#include <vertical3d/core/CreatePolyCommandSet.h>
...
//	_window->addTickListener(boost::bind(&Scene::tick, boost::ref(_scene), _1));
	...
	// initialize vgui
	boost::shared_ptr<v3D::FontCache> fc(new v3D::FontCache());
	cm_.reset(new Luxa::ComponentManager(fc, directory_));
