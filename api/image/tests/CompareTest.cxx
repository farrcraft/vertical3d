...
BOOST_AUTO_TEST_CASE(compare_identical_test) {
    v3d::image::Image a = solid(2, 2, 24, 128);
    v3d::image::Image b = solid(2, 2, 24, 128);
...
BOOST_AUTO_TEST_CASE(compare_dimensions_test) {
    v3d::image::Image a = solid(2, 2, 24, 0);
    v3d::image::Image b = solid(2, 3, 24, 0);
...
BOOST_AUTO_TEST_CASE(compare_format_test) {
    v3d::image::Image a = solid(2, 2, 24, 0);
    v3d::image::Image b = solid(2, 2, 32, 0);
...
BOOST_AUTO_TEST_CASE(compare_tolerance_test) {
    v3d::image::Image a = solid(2, 2, 24, 100);
    v3d::image::Image b = solid(2, 2, 24, 100);
