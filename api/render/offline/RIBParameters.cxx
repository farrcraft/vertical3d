...
namespace v3d::render::offline {
    ...
    void ParameterList::add(const std::string & name, const RIBDeclaration & declaration,
    ...
    const RIBDeclaration * ParameterList::declaration(const std::string & name) const {
