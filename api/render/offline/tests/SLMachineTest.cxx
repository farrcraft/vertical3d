...
typedef v3d::render::offline::SLOpcode Opcode;
typedef v3d::render::offline::SLProgram Program;
typedef v3d::render::offline::SLRegister Register;
typedef v3d::render::offline::SLInstruction Instruction;
...
bool build(const std::string & source, Program* program, std::string* error) {
    ...
    v3d::render::offline::SLEmitter emitter(shaders[0], compiler.symbols());
...
BOOST_AUTO_TEST_CASE(slmachine_batch_of_one_test) {
    ...
    v3d::render::offline::SLMachine wide;
    ...
    v3d::render::offline::SLMachine single;
...
BOOST_AUTO_TEST_CASE(slmachine_uniform_is_one_element_test) {
    ...
    v3d::render::offline::SLMachine machine;
