...
class SLInstruction final {
 public:
    SLOpcode opcode = SLOpcode::MOVE;
 ...
 **/
class SLProgram final {
 public:
    SLShaderType type = SLShaderType::SURFACE;
    std::string name;
    std::vector<SLRegister> registers;
    std::vector<SLInstruction> instructions;
