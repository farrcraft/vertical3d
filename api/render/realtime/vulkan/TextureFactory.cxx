...
namespace v3d::render::realtime::vulkan {
    ...
    /**
     **/
    Texture TextureFactory::create(const boost::shared_ptr<v3d::image::Image>& image) const {
        if (!image) {
    ...
    /**
     **/
    Texture TextureFactory::create(const unsigned char* pixels, uint32_t width, uint32_t height, uint32_t channels) const {
        ...
        if (result != VK_SUCCESS) {
            std::stringstream msg;
            msg << "Unable to create a vulkan image - " << resultString(result);
            throw std::runtime_error(msg.str());
        }
        ...
        if (result != VK_SUCCESS) {
            ...
            std::stringstream msg;
            msg << "Unable to allocate memory for a vulkan image - " << resultString(result);
            throw std::runtime_error(msg.str());
        }
        ...
        if (result != VK_SUCCESS) {
            ...
            vkDestroyImage(device_->handle(), texture.image, nullptr);
            std::stringstream msg;
            msg << "Unable to bind memory to a vulkan image - " << resultString(result);
            throw std::runtime_error(msg.str());
        }
        ...
        if (result != VK_SUCCESS) {
            ...
            vkDestroyImage(device_->handle(), texture.image, nullptr);
            std::stringstream msg;
            msg << "Unable to create a vulkan image view - " << resultString(result);
            throw std::runtime_error(msg.str());
        }
        ...
        if (result != VK_SUCCESS) {
            ...
            vkDestroyImage(device_->handle(), texture.image, nullptr);
            std::stringstream msg;
            msg << "Unable to create a vulkan sampler - " << resultString(result);
            throw std::runtime_error(msg.str());
        }
