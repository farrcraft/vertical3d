...
namespace v3d::gl {
    GLTexture::GLTexture(const boost::shared_ptr<v3d::log::Logger> & logger) : logger_(logger) {
    }

    GLTexture::GLTexture(boost::shared_ptr<v3d::image::Image> image, const boost::shared_ptr<v3d::log::Logger> & logger) :
        logger_(logger) {
        create(image);
    }
