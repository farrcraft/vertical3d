...
namespace v3d::gl {
    ...
    class GLFontRenderer {
     public:
        explicit GLFontRenderer(const boost::shared_ptr<v3d::log::Logger> & logger);
        GLFontRenderer(const v3d::font::Font2D &f, const boost::shared_ptr<v3d::log::Logger>& logger);
