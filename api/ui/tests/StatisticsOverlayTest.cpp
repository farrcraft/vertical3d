...
BOOST_AUTO_TEST_CASE(a_frame_reads_as_milliseconds_and_a_rate) {
    ...
    const std::array<std::string, v3d::ui::shell::StatisticsOverlay::rows> lines =
        v3d::ui::shell::StatisticsOverlay::lines(sample);
...
BOOST_AUTO_TEST_CASE(no_rate_is_shown_before_the_first_frame) {
    const std::array<std::string, v3d::ui::shell::StatisticsOverlay::rows> lines =
        v3d::ui::shell::StatisticsOverlay::lines(v3d::ui::shell::StatisticsOverlay::Sample());
...
BOOST_AUTO_TEST_CASE(an_overlay_starts_hidden_and_toggles_both_ways) {
    ...
    v3d::ui::shell::StatisticsOverlay overlay(text);
