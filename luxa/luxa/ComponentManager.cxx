...
ComponentManager::ComponentManager(boost::shared_ptr<v3d::font::FontCache> fc,
    boost::shared_ptr<v3d::command::CommandDirectory> directory) :
    renderer_(fc), directory_(directory) {
}
