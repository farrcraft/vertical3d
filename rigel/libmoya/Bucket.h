		...
		*/
		class Bucket
		{
			public:
				...
				void 	addPrimitive(ReyesPrimitivePtr primitive);
				void	render(void);
			...
			private:
				...
				std::vector<ReyesPrimitivePtr>		_primitives;// list of primitives in this bucket
	
				std::vector<MicroPolygonGridPtr>	_grids;
		};
