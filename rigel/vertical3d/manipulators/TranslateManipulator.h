...
*/
#ifndef INCLUDED_V3D_TRANSLATE_MANIPULATOR_H
#define INCLUDED_V3D_TRANSLATE_MANIPULATOR_H
...
namespace v3D
{
	...
	class TranslateManipulator : public TransformManipulator
	{
		public:
			...
			virtual void transform(const Vector2 & delta);
	};

}; // end namespace v3D

#endif // INCLUDED_V3D_TRANSLATE_MANIPULATOR_H
