...
*/
#ifndef INCLUDED_VIEWPORTCOMMANDSET_H
#define INCLUDED_VIEWPORTCOMMANDSET_H
...
namespace v3D
{
	...
	class ViewPortCommandSet : public Command
	{
		public:
			ViewPortCommandSet();
			virtual ~ViewPortCommandSet();
...
#endif // INCLUDED_VIEWPORTCOMMANDSET_H
