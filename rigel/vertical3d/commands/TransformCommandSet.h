...
*/
#ifndef INCLUDED_TRANSFORMCOMMANDSET_H
#define INCLUDED_TRANSFORMCOMMANDSET_H
...
namespace v3D
{
	...
	class TransformCommandSet : public Command
	{
		public:
			TransformCommandSet();
			virtual ~TransformCommandSet();
...
#endif // INCLUDED_TRANSFORMCOMMANDSET_H
