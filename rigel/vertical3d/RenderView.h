...
*/
#ifndef INCLUDED_V3D_RENDERVIEW_H
#define INCLUDED_V3D_RENDERVIEW_H
...
namespace v3D
{
	...
	class RenderViewWindow : public Gtk::Window
	{
		public:
			RenderViewWindow();
			virtual ~RenderViewWindow();

			Gtk::DrawingArea * _renderView;
	};


}; // end namespace v3D

#endif // INCLUDED_V3D_RENDERVIEW_H
